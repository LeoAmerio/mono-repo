"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\Leo\\.cursor\\extensions\\wallabyjs.console-ninja-1.0.402\\out\\buildHook\\index.js').default({tool: 'nest.js', checkSum: '20af569a2f806f0eb41962UFYbAhdTCFcPCFRRBlEGBwJYAgUA', mode: 'runtime'}); } catch(cjsError) { try { import('file:///c:/Users/Leo/.cursor/extensions/wallabyjs.console-ninja-1.0.402/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20af569a2f806f0eb41962UFYbAhdTCFcPCFRRBlEGBwJYAgUA', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
